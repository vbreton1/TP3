...
freertos/src/%.o: ../freertos/src/%.c
	...
	arm-none-eabi-gcc -DDEBUG -D__CODE_RED -D__USE_LPCOPEN -D__REDLIB__ -DCORE_M4 -D__MULTICORE_NONE -I"D:\FG\MMM2\Sistemas_embebidos\Workspaces_para_MCUXpressoide\workspace-EDU_CIAA_NXP-TP3_v2\lpc_chip_43xx\inc" -I"D:\FG\MMM2\Sistemas_embebidos\Workspaces_para_MCUXpressoide\workspace-EDU_CIAA_NXP-TP3_v2\lpc_board_nxp_lpcxpresso_4337\inc" -I"D:\FG\MMM2\Sistemas_embebidos\Workspaces_para_MCUXpressoide\workspace-EDU_CIAA_NXP-TP3_v2\freertos_examples_10_to_16\example\inc" -I"D:\FG\MMM2\Sistemas_embebidos\Workspaces_para_MCUXpressoide\workspace-EDU_CIAA_NXP-TP3_v2\freertos_examples_10_to_16\freertos\inc" -O0 -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -fsingle-precision-constant -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -mthumb -D__REDLIB__ -fstack-usage -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
